...
if(isset($_POST['submit'])){
    ...
    $ngu=mysqli_query($conn,"INSERT INTO transaction(date_transaction,sum_price,status,id_admin,pnr_number) VALUES('$time','$sum','$status',$codea,$code) ");
...
<form method="POST">
    ...
    <div class="mb-3">
      ...
      <input name="time" type="datetime-local"  class="form-control" placeholder="Thời gian giao dịch" >
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input name="sum" type="text"  class="form-control" placeholder="Tổng tiền">
    </div><div class="mb-3">
